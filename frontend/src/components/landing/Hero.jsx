    ...
    <section className="w-full bg-gray-900 px-6 py-24 md:py-32">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-400 text-lg max-w-2xl mx-auto mb-10">
          Metrik gives you clear, real-time insights into your business
          metrics — no spreadsheets, no confusing charts, just answers.
        </p>

        {/* CTA Buttons */}
        <div className="flex items-center justify-center gap-4">
          <button className="bg-indigo-600 hover:bg-indigo-500 text-white font-medium px-6 py-3 rounded-lg transition-colors">
            Get Started Free
          </button>
